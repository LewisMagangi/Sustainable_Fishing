...
def catch_list(request):
    ...
    return render(request, 'catches/catch_list.html', context)
...
def catch_detail(request, catch_id):
    ...
    context = {'catch': catch}
    return render(request, 'catches/catch_detail.html', context)
...
def catch_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('catches:catch_detail', catch_id=catch.id)
    else:
        form = CatchForm()
    
    context = {'form': form}
    return render(request, 'catches/catch_form.html', context)
...
def catch_delete(request, catch_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('catches:catch_list')
    
    context = {'catch': catch}
    return render(request, 'catches/catch_confirm_delete.html', context)
...
def my_catches(request):
    ...
    return render(request, 'catches/my_catches.html', context)
