...
def content_list(request):
    ...
    return render(request, 'educational_content/content_list.html', context)
...
def content_detail(request, content_id):
    ...
    return render(request, 'educational_content/content_detail.html', context)
...
def content_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('educational_content:detail', content_id=content.id)
    else:
        form = EducationalContentForm()
    
    context = {'form': form}
    return render(request, 'educational_content/content_form.html', context)
...
def content_delete(request, content_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('educational_content:content_list')
    
    context = {'content': content}
    return render(request, 'educational_content/content_confirm_delete.html', context)
...
def my_content(request):
    ...
    return render(request, 'educational_content/my_content.html', context)
...
def featured_content(request):
    ...
    context = {'page_obj': page_obj}
    return render(request, 'educational_content/featured_content.html', context)
